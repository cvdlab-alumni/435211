...
def walls():
    ...
    glass_h_sud = T(2)(0.5)(R([2,3])(PI/2)(MATERIAL(glass)(t_hollows_sud)))
    
    sud = [s1, T(3)(3)(s2),T(3)(3)(glass_h_sud)]
    ...
    glass_h_ovest = T(2)(-0.1)(T([1,2])([1.1,4.8])(R([1,2])(PI/2)(R([2,3])(PI/2)(MATERIAL(glass)(t_hollows_f1_o)))))
    ...
    glass_h_o2 = T(2)(0.5)(R([1,2])(PI/2)(R([2,3])(-PI/2)(R([1,2])(PI)(MATERIAL(glass)(STRUCT([t1_hollows_o,t2_hollows_o,t3_hollows_o]))))))
    
    
    ovest = [o1,glass_h_ovest,T([1,2,3])([0,8,3])(o2),T([1,2,3])([0,8,3])(glass_h_o2)]
    ...
    glass_h_n1 = T(2)(-0.1)(T([1,2])([7.1,8.3])(R([2,3])(PI/2)(R([1,3])(PI)(MATERIAL(glass)(T([1,2])([0.8,1])(hollow_f1_n))))))
    ...
    glass_h_n2 = T(2)(0.5)(T([1,2,3])([8,8,3])(R([2,3])(PI/2)(R([1,3])(PI)(MATERIAL(glass)(t_hollows_nord)))))
    
    nord = [n1,n2,glass_h_n2,glass_h_n1]
    ...
    glass_h_e1 = T(2)(-0.1)(T([1,2])([7.1,4.8])(R([1,2])(PI/2)(R([2,3])(PI/2)(MATERIAL(glass)(t_hollows_f1_e)))))
    ...
    e2 = T(2)(0.5)(T([1,2,3])([8,0,3])(R([1,2])(PI/2)(R([2,3])(PI/2)((DIFFERENCE([o2_2,t3_hollows_e]))))))
    glass_h_e2 = T(2)(0.5)(T([1,2,3])([8,0,3])(R([1,2])(PI/2)(R([2,3])(PI/2)(MATERIAL(glass)(STRUCT([t1_hollows_e,t2_hollows_e,t3_hollows_e]))))))
    est = [e1,e2,glass_h_e2,glass_h_e1]
